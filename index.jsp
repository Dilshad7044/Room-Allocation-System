...
<div class="FooterWrap">
  <div class="FooterLinksContainer">
    <div class="FooterLinksWrapper">
        <div class="FooterLinkItems">
           ...
           <!-- <a href="aboutme.jsp" class="FooterLink">Developers</a>-->
            <a href="aboutme.jsp" class="FooterLink">About us</a>
            <a href="service.jsp" class="FooterLink">Service</a>
            <a href="Admin/adminlogin.jsp" class="FooterLink">Admin</a>
        </div>
    </div>
  </div>
  ...
  <div class="SocialMedia">
    <div class="SocialMediaWrap">
      ...
      <p class="WebsiteRights">MANUU © 2023 </p>
